...
<div id="grouped_recetas_mini_cart" class="ui-box-ordenar-cart ui-loader">
	...
	<h3 class="ui-box-cart-title">SELECCIÓN DE RECETAS</h3>
	...
	?>
	<p id="grouped_recetas_rest_amout" class="amout-msg font-size-13"><span id="grouped_recetas_rest_count" class="count"><?php echo !empty($grouped_recetas) ? $grouped_recetas : '0'; ?></span> 
	...
	<h3 class="ui-box-cart-title">PLAN</h3>

	<p class=""><span id="grouped_personas_count" class="count_personas"><?php echo $grouped_personas; ?></span> 
		<?php 
	...
	<hr class="hide-on-affix">

	<h3 class="hide-on-affix ui-box-cart-title">SELECCIÓN</h3>
	<div id="grouped_recetas_list" class="hide-on-affix gmb-1 grouped_recetas_list">
	...
	<div class="ui-box-cart-footer gmb-2">
	...
	if ( $quantites_required ) : ?>
		...
		?>
		<p class="text-center gmt-1 m-0 small"><a href="<?php echo get_the_permalink($ordenar_page_id); ?>">Cambiar Plan <i class="fa fa-angle-right"></i></a></p>
